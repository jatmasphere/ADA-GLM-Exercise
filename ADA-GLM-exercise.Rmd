...
---
title: <center>White-throated Sparrow Morphs</center>
output: 
  html_document:
    df_print: paged
---
...
Using a binned residual plot to verify that the data works in a binomal GLM:
...
What is the expected number of Grasshopper Sparrow that may be predicted in a 100ha grassland? ANSWER=e^(-3.935+0.021*100), or _ and _ for 100km.
