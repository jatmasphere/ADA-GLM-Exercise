...
```
```{r histogram, include=FALSE, fig.align="center"}
...
* The expected number of Grasshopper Sparrows that may be predicted in a 200ha grassland is e^(-3.935+0.021*100), or 1.3 birds in every 200ha plot.
